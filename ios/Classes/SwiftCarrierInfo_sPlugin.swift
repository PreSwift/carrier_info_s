...
public class SwiftCarrierInfo_sPlugin: NSObject, FlutterPlugin {
    fileprivate let carrier = Carrier()

  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "plugins.chizi.tech/carrier_info_s", binaryMessenger: registrar.messenger())
    let instance = SwiftCarrierInfo_sPlugin()
